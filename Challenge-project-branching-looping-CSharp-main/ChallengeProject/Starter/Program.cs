...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            do
            {
                Console.WriteLine($"Enter an age for {ourAnimals[3, 0]}:");
                readResult = Console.ReadLine();
                if (readResult != null)
                {
            ...
            do
            {
                Console.WriteLine($"Enter a physical description for {ourAnimals[3, 0]} (size, color, breed, gender, weight, housebroken)");
                readResult = Console.ReadLine();
        ...
        case "4":
            do
            {
                Console.WriteLine($"Enater Nickname for {ourAnimals[3, 0]}:");
                readResult = Console.ReadLine();
                if (readResult == "")
                {
                    validEntry = false;
            ...
            do
            {
                Console.WriteLine($"Enter a personality description for {ourAnimals[3, 0]} (likes or dislikes, tricks, energy level)");
                readResult = Console.ReadLine();
                if (readResult != "") validEntry = true;
                else
                {
                    animalPersonalityDescription = readResult.ToLower();
                    validEntry = false;
            ...
            ourAnimals[3, 3] = "Nickname: " + animalNickname;
            ourAnimals[3, 4] = "Physical description: " + animalPhysicalDescription;
